...
import Phone3D from "../AnimatedShowcase";
    ...
    <div className="relative w-full overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ opacity: 0.5, zIndex: 1 }}>
          <Squares 
            speed={0.15}
            squareSize={35} // Increased square size for better visibility
            direction="diagonal"
            borderColor="#22d3ee"
      ...
      <div className="relative flex flex-col gap-5 items-center max-w-7xl mx-auto px-6 sm:px-8 h-screen">
        ...
        <motion.div 
          className="w-full text-center max-w-2xl mx-auto absolute top-1/2 -translate-y-3/3"
        ...
        >
          {/* Phone container */}
          <div className="relative w-full max-w-sm sm:max-w-md h-[520px] z-10">
            <Phone3D />
          </div>
        </motion.div>
      </div>
